# Agent Instructions for Policyminer

## Project Context
Policyminer is an open source Extract governance policies from agent behavior logs.

## Repository Layout
- `src/aumai_policyminer/` — package source
